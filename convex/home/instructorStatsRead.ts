...
import { getMyInstructorPayoutSnapshotRead } from "./instructorStatsPayout";
...
async function getMyInstructorHomeStatsRead(ctx: QueryCtx) {
  ...
  return {
    isVerified: internalAccess.verificationBypass || payoutSnapshot.hasVerifiedDestination,
    openMatches,
    pendingApplications,
