/**
 * Instructor Add Account Sheet - add another account to this device.
 */
...
export function InstructorAddAccountSheet({ visible, onClose }: InstructorAddAccountSheetProps) {
  ...
  const pathname = "/instructor/profile/add-account";
  ...
  const oauthRedirectTo = useMemo(
    () =>
      AuthSession.makeRedirectUri({
        native: `queue://instructor/profile/add-account`,
        scheme: "queue",
        path: "instructor/profile/add-account",
      }),
    [],
  );
