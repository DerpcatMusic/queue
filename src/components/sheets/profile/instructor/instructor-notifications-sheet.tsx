/**
 * Instructor Notifications Sheet - notification settings for instructors.
 */
...
interface InstructorNotificationsSheetProps {
  visible: boolean;
  onClose: () => void;
}
...
export function InstructorNotificationsSheet({
  visible,
  onClose,
