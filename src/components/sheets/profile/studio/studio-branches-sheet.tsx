...
interface StudioBranchesSheetProps {
  visible: boolean;
  onClose: () => void;
}

export function StudioBranchesSheet({ visible, onClose }: StudioBranchesSheetProps) {
  ...
  return (
    <BaseProfileSheet visible={visible} onClose={onClose}>
      <ScrollView
        ...
        contentContainerStyle={{ gap: BrandSpacing.lg, paddingBottom: BrandSpacing.xxl }}
      >
                  ...
                  <Box style={styles.sectionCardContent}>
                    ...
                    <Box style={styles.metaGrid}>
                      ...
                      <Box style={styles.metaItem}>
                        ...
                        <ThemedText type="bodyMedium" style={{ color: palette.text }}>
                          {t("jobsTab.form.minutes", {
                            value: branch.autoExpireMinutesBefore ?? 30,
                          })}
                        </ThemedText>
                      </Box>
                      <Box style={styles.metaItem}>
