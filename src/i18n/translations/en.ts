const en = {
  ...
  profile: {
    ...
    navigation: {
      ...
      studioCompliance: "Studio verification",
      studioChargeActivity: "Charge activity",
    ...
    setup: {
      ...
      statusReady: "Ready",
      statusPending: "{{count}} tasks left",
      nextStep: "Next: {{step}}",
      allClear: "Profile ready",
    },
    language: {
      title: "Language",
    ...
    compliance: {
      ...
      identity: {
        ...
        required: "Verify your identity to unlock instructor job actions.",
      ...
      insurance: {
        ...
        missingBody: "Upload your active liability insurance.",
        missingBodyCountry: "Upload your active {{country}} liability insurance.",
    ...
    studioCompliance: {
      loading: "Loading studio setup...",
      status: {
        loading: "Checking studio readiness...",
        ready: "Ready to publish jobs",
        pendingCount: "{{count}} verification steps left",
        blocked: "Finish verification: {{blockers}}",
      },
      hero: {
        readyTitle: "Studio can publish jobs",
        readyBody: "Representative identity, business details, and payments are ready.",
        blockedTitle: "Finish studio verification",
        blockedBody: "Posting jobs stays locked until these are done: {{blockers}}.",
      },
      sections: {
        overview: "Studio verification",
        overviewDescription: "Three things unlock publishing: representative identity, business details, and payments.",
        identity: "Verify representative",
        identityDescription: "Verify the studio owner or authorized representative with Didit.",
        billing: "Business details",
        billingDescription: "The legal details used for invoices and compliance.",
        payment: "Payments",
        paymentDescription: "Add the bank account or card used to pay instructors.",
      },
      identity: {
        title: "Representative verification",
        approvedBody: "Identity is approved for {{legalName}}.",
        requiredBody: "Verify the studio owner or authorized representative with Didit's native flow.",
        startVerification: "Verify representative",
        refreshVerification: "Refresh status",
      },
      billing: {
        country: "Country",
        ...
        taxIdPlaceholderDE: "e.g. 28/123/45678",
        taxIdFR: "SIREN",
        taxIdPlaceholderFR: "e.g. 123456789",
        taxIdES: "NIF",
        taxIdPlaceholderES: "e.g. B12345678",
        taxClassification: "Tax classification",
        billingEmail: "Billing email",
        billingPhone: "Billing phone",
        billingAddress: "Billing address",
        detectedCountry: "Detected from studio location: {{country}}",
        useStripeAddress: "Use studio address",
        moreDetails: "More details",
        hideMoreDetails: "Hide details",
        vatReportingType: "VAT reporting type",
        companyReg: "Company registration number",
        companyRegDE: "Handelsregister number",
        companyRegFR: "RCS number",
        companyRegES: "Registro Mercantil number",
        legalForm: "Legal form",
        changeCountryTitle: "Change country?",
        changeCountryBody: "Country-specific fields will be cleared. This cannot be undone.",
        unsavedTitle: "Discard changes?",
        unsavedBody: "You have unsaved changes that will be lost.",
        completeSummary: "Billing profile complete for {{name}}.",
        incompleteSummary: "Add the legal business details used for invoices and compliance.",
        editBilling: "Edit business details",
        startBilling: "Add business details",
        saveDetails: "Save business details",
        vatOptions: {
      ...
      payment: {
        title: "Payments",
        readyBody: "Payment details are ready for instructor payouts.",
        failedBody: "Payment setup failed. Review payments before publishing jobs.",
        pendingBody: "Payment details are still being set up.",
        missingBody: "Finish payments before publishing jobs.",
        readySummary: "Payment method is ready for instructor payouts.",
        setupSummary: "Add a bank account or card to pay instructors after lessons.",
        managePayments: "Manage payments",
        startSetup: "Set up payments",
      },
      wizard: {
        stepLabel: "Step {{current}}",
        stepCounter: "Step {{current}} of {{total}}",
        identityTitle: "Verify the studio representative",
        identityBody: "Open Didit's native identity flow. We sync the result back automatically.",
        businessTitle: "Add business details",
        businessBody: "Keep the legal details tight. Hide the rest unless you need them.",
        paymentTitle: "Set up payments",
        paymentBody: "Add the bank account or card used to pay instructors.",
        next: "Next",
        openJobs: "Open jobs",
      },
      actions: {
    ...
    settings: {
      ...
      deleteAccount: {
        ...
        warningText:
          "This will permanently delete your {{role}} account and all associated data. This action cannot be undone.",
        sendCode: "Send verification code",
        verifyTitle: "Enter verification code",
        verifySubtitle: "We've sent a 6-digit code to {{email}}. It expires in 10 minutes.",
        codePlaceholder: "123456",
        invalidCodeLength: "Please enter the 6-digit code.",
        verificationFailed: "Verification failed. Please try again.",
        verifyButton: "Verify & delete",
        resendCode: "Didn't receive the code? Resend",
        successTitle: "Account scheduled for deletion",
        successMessage: "Your account and data will be permanently deleted within 30 days in compliance with GDPR Article 17.",
        verificationSentTitle: "Verification code sent",
        verificationSentMessage: "Check your email for a 6-digit code to confirm account deletion.",
      ...
      location: {
        ...
        workRadiusPlaceholder: "e.g. 0.25",
      },
      calendar: {
        title: "Calendar sync",
    ...
    payments: {
      summarySubtitle: "Manage saved payment methods and review studio charge activity.",
      ...
      studioSubtitle: "Saved methods for studio charges and a history of processed payments.",
      ...
      liveStatusHint:
        "Use this screen for saved payment methods and charge history. Publishing readiness lives under studio setup.",
  ...
  onboarding: {
    ...
    verification: {
      ...
      body: "Complete Stripe identity onboarding, upload your insurance, and add teaching certificates. Insurance and certificates go through AI-assisted review, and you can keep browsing while they are under review.",
      studioBody:
  ...
  mapTab: {
    ...
    mobile: {
      ...
      commuteEstimate: "Approx. {{minutes}} min commute",
      activeResolution: "Res {{resolution}}",
      savedCoordinates: "Saved {{latitude}}, {{longitude}}",
  ...
  jobsTab: {
    ...
    instructorFeed: {
      ...
      currentLessonsTitle: "Current lessons",
      currentLessonsSubtitle: "Check out with GPS when the lesson is done.",
      readyToComplete: "Ready to complete",
      completeNearEnd: "Complete near end time",
    ...
    jobs: {
      slotsAvailable: "{{count}} spots left",
      nearCapacity: "Filling fast",
    },
    actions: {
      post: "Post job",
      posting: "Posting...",
    ...
    errors: {
      ...
      maxApplicationsReached: "This job has received the maximum number of applications. Please try again later.",
      jobNotOpen: "This job is no longer accepting applications.",
      bookingConflict: "You already have a booking at this time. Please check your calendar.",
      applicationDeadlinePassed: "The application deadline for this job has passed.",
  },
  home: {
    loading: "Loading your dashboard...",
    internal: {
      testBadge: "TEST ACCOUNT",
    },
    actions: {
      jobsTitle: "Jobs",
    ...
    instructor: {
      ...
      monthProgress: "{{percent}}% through month",
    ...
    tasks: {
      ...
      allDone: "Everything here is already complete.",
      remaining: "{{count}} setup items left.",
      instructor: {
        title: "Finish your setup",
        verifyDescription: "Identity verification unlocks applications and payouts.",
        payoutsDescription: "Add your payout destination so completed lessons can pay out.",
        profileTitle: "Complete your profile",
        profileDescription: "Add a polished bio and the public profile details studios scan first.",
        sportsDescription: "Choose the sports you teach so matching jobs show up correctly.",
      },
      studio: {
        title: "Finish studio setup",
        readinessTitle: "Finish studio verification",
        ownerTitle: "Verify your identity",
        ownerDescription:
          "Identity, business details, and payments are required before posting jobs.",
        businessTitle: "Add business details",
        businessDescription:
          "Complete the legal business details used for invoices and compliance.",
        paymentsDescription:
          "Finish payments so your studio is ready to pay instructors and publish jobs.",
        profileTitle: "Complete studio details",
        profileDescription:
          "Add your address and sports so instructors know where and what you hire for.",
        sportsDescription: "Add the sports your studio hires for.",
        branchTitle: "Set up your main branch",
        branchDescription: "Add your teaching location so check-ins, maps, and reminders work.",
      },
    },
    checkIn: {
      eyebrow: "Check-in",
      title: "Your next lesson is ready",
      body: "When you arrive nearby, confirm arrival and Queue will verify your location.",
      checkedInTitle: "Arrival confirmed",
      checkedInBody: "You are checked in. Head inside and start the lesson.",
