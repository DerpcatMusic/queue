const en = {
  ...
  profile: {
    ...
    studioCompliance: {
      ...
      sections: {
        overview: "Studio setup",
        overviewDescription:
          "One place for address, branches, identity, billing, and payment readiness.",
      ...
      identity: {
        ...
        requiredBody:
          "Verify your identity to enable payouts and job posting.",
      ...
      billing: {
        ...
        incompleteSummary: "Add your legal business details to enable invoicing and payouts.",
        editBilling: "Edit billing profile",
        startBilling: "Set up billing profile",
        vatOptions: {
      ...
      payment: {
        ...
        readySummary: "Payouts and payments are active.",
        setupSummary: "Connect a bank account to receive payouts from job payments.",
        managePayments: "Manage payments",
        startSetup: "Set up payouts",
      },
      actions: {
  ...
  home: {
    ...
    tasks: {
      ...
      studio: {
        ...
        ownerTitle: "Verify the owner",
        ownerDescription: "Owner verification is required before your studio can publish fully.",
        businessTitle: "Add business details",
        businessDescription: "Complete the legal business profile used for compliance and billing.",
        paymentsDescription: "Connect your payment setup so the studio can run jobs and payments.",
        profileTitle: "Complete the studio profile",
        profileDescription: "Add a strong studio bio so instructors understand the space quickly.",
        sportsDescription: "Add the sports your studio hires for and teaches.",
