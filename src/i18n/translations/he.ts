const he = {
  ...
  profile: {
    ...
    switcher: {
      ...
      sheetBody: "בדקו את החשבון הפעיל במכשיר הזה, עברו לחשבון אחר, או התנתקו.",
      ...
      accountsBody: "פתחו מסך מעבר ייעודי לפני שיוצאים מהחשבון הנוכחי במכשיר הזה.",
      useAnotherAccountTitle: "שימוש בחשבון אחר",
      useAnotherAccountHint: "בחרו קודם אם להתחבר או ליצור חשבון נוסף לפני שיוצאים מהחשבון הזה.",
