const he = {
  ...
  profile: {
    ...
    compliance: {
      ...
      identity: {
        title: "זהות",
        approved: "הזהות אומתה.",
        required: "אמתו את הזהות כדי לפתוח פעולות מדריך.",
        unverified: "לא מאומת",
        cardTitle: "אימות זהות",
  ...
  jobsTab: {
    ...
    instructorFeed: {
      ...
      currentLessonsTitle: "שיעורים פעילים",
      currentLessonsSubtitle: "בצעו צ'ק-אאוט עם GPS כשהשיעור מסתיים.",
      readyToComplete: "מוכן להשלמה",
      completeNearEnd: "להשלים סמוך לסיום",
