  ...
  profile: {
    ...
    compliance: {
      ...
      identity: {
        ...
        unverified: "לא מאומת",
        cardTitle: "אימות זהות עם Didit",
        cardBody: "אימות ביומטרי ומסמכים כדי לפתוח גישת מדריך.",
    ...
    studioCompliance: {
      ...
      sections: {
        ...
        identityDescription: "אישור Didit הוא דרישת הזהות המחייבת לפרסום משרות בסטודיו.",
        billing: "פרופיל חיוב",
        billingDescription:
      ...
      identity: {
        ...
        requiredBody: "הסטטוס הנוכחי: {{status}}. השלימו Didit כדי לפתוח פרסום משרות.",
      },
      billing: {
      ...
      feedback: {
        ...
        identityRefreshStarted: "סטטוס Didit עודכן. נשמור כאן את התוצאה האחרונה.",
    ...
    payments: {
      ...
      airwallexDirectSplitNote:
        "כספי המדריך/ה עוברים ישירות לחשבון Airwallex המקושר. שום דבר לא עובר דרך ארנק משיכות של הפלטפורמה.",
      airwallexNotConnected: "חשבון Airwallex לא מחובר",
      airwallexActive: "חשבון Airwallex פעיל",
      airwallexActionRequired: "נדרשת פעולה ב-Airwallex",
      airwallexBlocked: "חשבון Airwallex חסום",
      airwallexActiveHint: "החשבון המקושר מוכן לקבל כספי split.",
      airwallexActionRequiredHint:
        "Airwallex עשויה לבקש אימות נוסף לפני שהחשבון יוכל לקבל כספי split.",
      airwallexBlockedHint:
        "החשבון עדיין לא יכול לקבל כספי split. צריך לבדוק את סטטוס האימות והחשבון.",
      airwallexConnectTitle: "לחבר את חשבון Airwallex?",
      airwallexConnectBody:
        "הפעולה הזו יוצרת או מרעננת את החשבון המקושר שמשמש להסדרת split ישיר למדריכים.",
      airwallexConnectAccount: "חיבור Airwallex",
      airwallexContinueOnboarding: "המשך onboarding ב-Airwallex",
      airwallexRefreshAccount: "רענון סטטוס",
      airwallexConnected: "חשבון Airwallex חובר.",
      airwallexConnectStarted: "הגדרת חשבון Airwallex עודכנה.",
      airwallexConnectFailed: "חיבור חשבון Airwallex נכשל.",
      airwallexOnboardingTitle: "onboarding ב-Airwallex",
      airwallexOnboardingLoading: "טוען onboarding מאובטח של Airwallex...",
      airwallexOnboardingHint:
        "אפשר להשלים כאן את שלבי ה-onboarding של Airwallex. סטטוס הארנק והמשיכות יתעדכן אוטומטית כשיגיעו אירועים חדשים.",
      airwallexOnboardingLoadFailed: "טעינת ה-onboarding של Airwallex נכשלה.",
      airwallexOnboardingRetryHint:
        "נסו שוב בעוד רגע. אם זה ממשיך להיכשל, רעננו קודם את חשבון Airwallex.",
      ...
      notCreated: "לא נוצר",
      liveStatusHint: "המסך הזה מתעדכן אוטומטית כשאירועי Airwallex מתקבלים.",
      ...
      releaseInstructorFundsSuccess: "כספי המדריך/ה שוחררו למחזור הסליקה של Airwallex.",
      ...
      finalizingBody: "ממתינים ל-Airwallex כדי לאשר את יעד המשיכה.",
