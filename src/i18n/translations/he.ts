const he = {
  ...
  profile: {
    ...
    studioCompliance: {
      ...
      hero: {
        ...
        readyBody: "זהות הבעלים, פרופיל החיוב ומוכנות התשלומים כולם במצב שמאפשר פרסום משרות.",
      ...
      sections: {
        ...
        identityDescription: "אישור זהות הוא דרישת חובה לפרסום משרות בסטודיו.",
        billing: "פרופיל חיוב",
        billingDescription:
          "שמרו את פרטי העסק החוקיים כפנימיים כדי שחשבוניות, סליקה ומיסוי יישארו מיושרים.",
        payment: "תשלומים",
        paymentDescription: "צריך להגדיר מוכנות לסליקה לפני שהסטודיו יכול לפרסם משרות בתשלום.",
      },
      identity: {
        title: "אימות בעל/ת הסטודיו",
        approvedBody: "הזהות אושרה עבור {{legalName}}.",
        requiredBody: "הסטטוס הנוכחי: {{status}}. השלימו אימות זהות כדי לפתוח פרסום משרות.",
      },
      billing: {
      ...
      blockers: {
        identity: "אישור זהות של בעל/ת הסטודיו",
    ...
    payments: {
      ...
      notCreated: "לא נוצר",
      liveStatusHint: "המסך הזה מתעדכן אוטומטית כשאירועי Stripe לחשבון ולתשלומים מתקבלים.",
  ...
  home: {
    ...
    studio: {
      ...
      boardSummaryBody: "{{open}} משרות פתוחות, {{pending}} מועמדים בהמתנה ו-{{filled}} אוישו לאחרונה.",
    },
    tasks: {
      done: "הושלם",
      ...
      studio: {
        ...
        ownerTitle: "אימות בעל/ת הסטודיו",
        ownerDescription: "נדרש אימות בעלות לפני שהסטודיו יכול לפרסם באופן מלא.",
        businessTitle: "הוספת פרטי עסק",
        businessDescription: "השלימו את פרופיל העסק החוקי לצורכי ציות וחיוב.",
        paymentsDescription: "חברו את הגדרות התשלום כדי שהסטודיו יוכל להפעיל משרות ותשלומים.",
        profileTitle: "השלמת פרופיל הסטודיו",
        profileDescription: "הוסיפו ביו ברור כדי שמדריכים יבינו מהר את האווירה והמרחב.",
        sportsDescription: "הוסיפו את התחומים שהסטודיו מלמד ומגייס עבורם.",
