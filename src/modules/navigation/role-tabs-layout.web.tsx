...
export function RoleTabsLayout({ appRole, badgeCountByRoute }: RoleTabsLayoutProps) {
  ...
  const activeTab = useMemo(() => {
    const activeRouteName = resolveRoleTabRouteName(pathname, appRole);
    return tabs.find((tab) => tab.routeName === activeRouteName) ?? tabs[0];
                          ...
                          <View style={{ flex: 1, gap: 2 }}>
                            <Text
                              style={{
                                ...
                                fontWeight: "700",
                                letterSpacing: 0.2,
                                color: selected ? palette.onPrimaryContainer : palette.text,
                              }}
                            >
                              {t(tab.titleKey)}
                            </Text>
                            <Text
                              style={{
                                fontSize: 12,
                                color: selected ? palette.onPrimaryContainer : palette.textMuted,
                              }}
                            >
                          ...
                          {badgeCount > 0 ? (
                            <View
                              style={{
                                minWidth: 28,
                                borderRadius: 999,
                                backgroundColor: selected ? palette.onPrimaryContainer : palette.primary,
                                paddingHorizontal: 8,
                                paddingVertical: 4,
                                alignItems: "center",
                              }}
                            >
                              <Text
                                style={{
                                  fontSize: 12,
                                  fontWeight: "700",
                                  color: selected ? palette.primaryContainer : palette.onPrimary,
                                }}
                              >
